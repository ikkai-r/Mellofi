...
<html lang="en">
  ...
  <body>
   <!-- Start Header -->
    <nav class="navbar navbar-expand-lg navbar-light bg-custom-nav" style="z-index: 9">
       ...
       echo '  <ul class="navbar-nav mr-auto ml-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item dropdown"> 
              <a class="nav-link dropdown-toggle nav-item-custom mr-2" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"style="margin-left: 5px" id="music">MUSIC</a>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="pop.php"><i class="fas fa-music"></i> Pop</a>
                <a class="dropdown-item" href="chill.php"><i class="fas fa-music"></i> Chill</a>
              </div>
            </li>
          </ul>';
...
?>
      ...
      echo'
      <!-- Search Bar -->
              <form style="width: 500px; margin-left: 280px"action="search.php" method="get" class="search">
  ...
  <?php
      ...
      $sql_stream = "
        SELECT DISTINCT
         ...
         `livestreams`.thumbnail,
         `livestreams`.title,
         `livestreams`.stream_time,
         `livestreams`.viewer_cnt,
         `livestreams`.price,
         `livestreams`.status,
        ...
        INNER JOIN 
          ...
          WHERE 
          `genre`.genre LIKE '%".$query."%'
          OR
          `livestreams`.title LIKE '%".$query."%'
          OR
          `musician`.username LIKE '%".$query."%'
      ...
      $result_stream = mysqli_query($conn, $sql_stream);
          ...
          if ($count_stream > 0) {
            // if there are live
             ...
             echo '
             <h2 style="text-align:center">All results for <span style="color:#A200FF">"'.$query.'"</span>:</h2>
             ...
             echo '
              ...
              <div class="jumbotron" style="margin-left: 400px; margin-top: 15px">
                <div class="container">
                     <h3><i class="fas fa-video" style="font-size: 100px"></i></h3>
                      <h1>No livestreams found for <span style="color:#A200FF">"'.$query.'"</span></h1>
                     <p class="lead">Discover other livestreams <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
           ...
           <p class="viewer-cnt">'.$videos[$index]["viewer_cnt"].' views <span style="font-size: 12px;">| Uploaded '.$videos[$index]["stream_time"].' ago<span></p>
            ...
            //if there is no videos 
              ...
              <div class="jumbotron" style="margin-left: 400px; margin-top: 15px">
                <div class="container">
                     <h3><i class="fas fa-video" style="font-size: 100px"></i></h3>
                      <h1>No videos found for <span style="color:#A200FF">"'.$query.'"</span></h1>
                     <p class="lead">Discover other videos <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
          }
    ?>
...
<!-- Start Tracks Tab -->
      ...
      $count = mysqli_num_rows($result_music);
              ...
              if ($count > 0) {
                //if there are tracks in pop genre

          for ($index = 0; $index < count($music); $index++) {
            echo'            
            <div class="col-3 mt-3">
              <a href="music.php?='.$music[$index]["music_id"].'">
                ...
                <a style="color: white;" href="music.php?music='.$music[$index]["music_id"].'">
                <h4 style=" margin-bottom: 2px;">'.$music[$index]["title"].'</h4>
                 ...
                 //if there are no tracks in pop genre
            echo '
              <div class="jumbotron" style="margin-left: 390px; margin-top: 20px">
                <div class="container">
                     <h3><i class="fas fa-compact-disc" style="font-size: 100px"></i></h3>
                      <h1>No tracks found for <span style="color:#A200FF">"'.$query.'"</span></h1>
                     <p class="lead">Discover other tracks <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
  ...
  <div class="row custom-container mt-5">
      ...
      $result_artist = mysqli_query($conn, $sql_artist);
        ...
        $count = mysqli_num_rows($result_artist);
              ...
              if ($count > 0) {
                //if artist has a pop genre music
               ...
               <div class="col-3 mt-3">
                ...
                //if artist does not have a pop genre music

                      echo '
              <div class="jumbotron" style="margin-left: 430px">
                <div class="container">
                     <h3><i class="fas fas fa-user-astronaut" style="font-size: 100px"></i></h3>
                      <h1>No artists found for <span style="color:#A200FF">"'.$query.'"</span></h1>
                     <p class="lead">Discover other artists <a href ="homepage.php" style="color: #B303FF">here.</a></p
                </div>
              </div>';
