...
?>
  ...
  <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url(https://3.bp.blogspot.com/-soRoGgJNqnQ/W3wnrmdCLSI/AAAAAAAAaEs/meDo13lXYlcMnr6QSLa3EpkiW60B5h9tQCLcBGAs/s640/20180405-DSCF2495.jpg);">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 400px; ">UPDATE VIDEO</h1>
    </div>
  </div>
  <br>
  <br>
...
<div class="custom-container mt-5">
      <form action="updatingVid.php" method="post" style="width:100%"   enctype="multipart/form-data">  

               <div class="form-group">
            <label style="color: #8A2BE2"></label>
            <input type="hidden" class="form-control" name="video_id" required value = "<?php echo $_GET['video_id'];?>" >
          </div>           
          <div class="form-group">
            <?php
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="price"  value="'.$row_form["price"].'" style="background-color: black; color: white">
        ...
        <a href="contentUpload.php?musician_id='.$_GET["musician_id"].'&video_id='.$_GET["video_id"].'" style="color: white"><span class="btn" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Discard</span></a>
        <button type="submit" class="btn" name="update" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Update Video</button>
';
