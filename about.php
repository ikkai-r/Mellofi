...
?>
 ...
 <div>
    ...
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 540px; ">ABOUT US</h1>
    </div>
  </div>
  <div class="custom-container mt-5">
    <p>Mellofi is an online music platform which caters to Filipinos that wants to be discovered through music and also to those who want to explore different music genres made locally here in the Philippines. It was established in the year of 2021 by a group of students who want to help promote local music in the fast-growing music industry.</p>
    <br>
    <br>

    <h3 style="text-align: center">Our <span style="color:#A200FF">goal</span> is to have you:</h3>
    <br>
      <div class="row">
        <div class="col-3">
          <h5 style="color:#A200FF">Dream high</h5>
          <p>Those who are aspiring to be musicians or just want to make music as a hobby, we know you can do it!</p>
        </div>
        <div class="col-3">
          <h5 style="color:#A200FF">Collaborate</h5>
          <p>This website is mainly for indie artist that wants to have a chance to be BIG, so it is open for collaborators!</p>      
        </div>
        <div class="col-3">
          <h5 style="color:#A200FF">Gain income</h5>
          <p>We want you to have a chance to make music for a living.</p>     
        </div>
        <div class="col-3">
          <h5 style="color:#A200FF">Support musicians</h5>
          <p>Local artists or indie artists who are just starting with their music career.</p>
        </div>
      </div>
  </div>
</div>

<h1 style="text-align:center; color:#A200FF; margin-top: 100px">OUR USERS' SUCCESS</h1>
<br>
<br>
<div class="custom-container">
<div class="row">
  <div class="col-6">
    <h1 class="card-title" style="color:#8A2BE2">Ben&Ben</h1>
    <br>
    <br>
    <h5 class="card-text">Ben&Ben was a group composed of 9 members and was into music so much. As time passes by, 
they still go back to the same places they’ve been before and do things they also have done before, 
which is playing music. But their name is still unpopular to many because there are a lot of other music 
artists more popular than them.</h5>
  </div>
  <div class="col-6">
    <p><img class="card-img" src="https://cdn.platinumlist.net/upload/artist/ben_ben_670-orig1536504252.jpg"><p>
  </div>
</div>  
<br>
<br>
<div class="row">
  <div class="col-6">
    <p><img class="card-img" src="https://assets2.rappler.com/2020/09/1599045671-20200902-Ben-Ben-Dynamite-546.jpg"><p>
  </div>
  <div class="col-6">
    <br>
    <br>
    <br>
    <h5 class="card-text">The pandemic started, there were no open bars or restaurants for 
them to have gigs and performances that helps them gain money. That is when they tried playing their 
music online! With the help of Mellofi, they play music all they want and gain more popularity because 
everyone can access the website with only internet connection and not having to go to places artists perform. Ben&Ben is now one of the highest grossing artist here in the Philippines and 
puts “kilig” and thorns in our hearts!</h5>
  </div>
  </div>
<br>
<br>
...
<div class="row">
  <div class="col-6">
    <h1 class="card-title" style="color:#8A2BE2">Munimuni</h1>
    <h5 class="card-text">Munimuni is composed of students from UP Diliman Campus and was formed in the year 2012, they 
have gone through a lot, like when their guitarist/vocals, TJ de Ocampo, have leave the country and go 
to Japan as an exchange student. They performed at gigs and event every night because they love the 
music, they are playing but during this time, there are a lot of independent artists, this time it was just 
like an era where indie artist has grown all over the country and also the rise of big record labels holder 
artists. </h5>
  </div>
  <div class="col-6">
    <p><img class="card-img" src="https://www.filepicker.io/api/file/GZDbp2pPQxCPBIAvkmB8/convert?cache=true&crop=0%2C0%2C1920%2C960&crop_first=true&quality=90&w=1920"><p>
  </div>
</div>  
<br>
<br>
<div class="row">
  <div class="col-6">
    <p><img class="card-img" src="https://i.pinimg.com/originals/a4/0c/12/a40c1262b60fd3c935c66593ef1efdd6.jpg"><p>
  </div>
  <div class="col-6">
    <br>
    <br>
    <h5 class="card-text">Because of that, Munimuni doesn’t make that much attraction to people making them state on 
twitter that they were on hiatus state. But a month ago, they created a post in which it says “abangan 
niyo kami sa Mellofi!” and up until now, many devoted listeners from the year they are formed are 
watching them through our website and seems to be captivating the heart and ears of every listener 
through their story-telling type of music!</h5>
  </div>
  </div>        
 </div>
