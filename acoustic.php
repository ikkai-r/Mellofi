...
?>
 ...
 <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url(images/bg-acoustic.jpg);">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 520px; ">ACOUSTIC</h1>
    </div>
  </div>
...
<!--Start Tab Content-->
 ...
 <!--Start Tracks Tab-->
      ...
      $count = mysqli_num_rows($result_music);
              ...
              if ($count > 0) {
                //if there are tracks in acoustic genre
            ...
            <div class="col-3 mt-3">
              <a href="music.php?music_id='.$music[$index]["music_id"].'">
                ...
                <h4 style=" margin-bottom: 2px;">'.$music[$index]["title"].'</h4>
                 ...
                 //if there are no tracks in acoustic genre
  ...
  <div class="row custom-container mt-5">
      ...
      $result_artist = mysqli_query($conn, $sql_artist);
        ...
        $count = mysqli_num_rows($result_artist);
              ...
              if ($count > 0) {
                //if artist has an acoustic genre music
               ...
               <div class="col-3">
                ...
                //if artist does not have an acoustic genre music
