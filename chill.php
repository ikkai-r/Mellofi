...
?>
  ...
  <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url('images/bg-chill.jpg');">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 640px; ">CHILL</h1>
    </div>
  </div>
          ...
          while ($row = mysqli_fetch_assoc($result_music)) {
            array_push($music, $row);
             ...
             $count = mysqli_num_rows($result_music);
              ...
              if ($count > 0) {
                //if there are tracks in chill genre
            ...
            <div class="col-3 mt-3">
              <a href="music.php?music_id='.$music[$index]["music_id"].'">
                ...
                <h4 style=" margin-bottom: 2px;">'.$music[$index]["title"].'</h4>
                 ...
                 //if there are no tracks in chill genre
          
           echo '
              <div class="jumbotron" style="margin-left: 420px">
                <div class="container">
  ...
  <div class="row custom-container mt-5">
      ...
      $result_artist = mysqli_query($conn, $sql_artist);
        ...
        $count = mysqli_num_rows($result_artist);
              ...
              if ($count > 0) {
                //if artist has a chill genre music
               ...
               <div class="col-3">
                ...
                //if artist does not have a chill genre music
