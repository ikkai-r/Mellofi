...
?>
  ...
  <i class="fas fa-link" style="margin-right: 15px"></i>         
    ...
    <li>
       <?php 
       echo'<a href="musician-subscription.php?musician_id='.$_GET['musician_id'].'" class="nav-link active creator-studio-icons">';
       ?> 
 ...
 <!-- settings start-->
   ...
   <!-- jQuery first, then Popper.js, then Bootstrap JS -->
    ...
    document.getElementById("confirmBtn").href="subscription-cancel.php?musician_id=" + musician_id + "&subscription_id=" + subscription_id; 
}
    </script>
  </body>
</html>