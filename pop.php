...
?>
 ...
 <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url(images/bg-pop.jpg);">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 640px; ">POP</h1>
    </div>
  </div>
 ...
 <!--Start Tracks Tab-->
  ...
  <div class="row custom-container mt-5">
      ...
      $result_artists = mysqli_query($conn, $sql_artists);
        ...
        $count_artists = mysqli_num_rows($result_artists);
    ...
    if ($count_artists > 0) {
             ...
             for ($index = 0; $index < count($artists); $index++) {
               ...
               <div class="col-3 mt-2">
                         <div class="following-artist" style="background-image: url(upload/images/'.$artists[$index]["profile_pic"].'); filter: blur(2px);">
                      </div>
                      <div class="following">
                          <a href="profile.php?musician_id='.$artists[$index]["musician_id"].'" class="following-div">
                         <img src="upload/images/'.$artists[$index]["profile_pic"].'" class="profile-pic following-pic" >
                        <h5 class="following-div">'.$artists[$index]["username"].'</h5>
                      </a>
                      </div>
                    </div>';
                   }
                ...
                //if artist does not have a pop genre
