           ...
           if (mysqli_num_rows($result) > 0){
               ...
               {  
                 ...
                 $res = $res . '</p>';
                  ...
                  $res = $res . '<div style="width:  310px;  height: 30px; background-color: #61129A; margin-top: 20px; text-align: center; text-transform: uppercase; margin-left: 10px;">';
                  $res = $res . $row['username'];
                  $res = $res . '</div>';
                  $res = $res . '<div style="width:  310px;  height: 80px; background-color: #7F10D0; margin-left: 10px; margin-bottom: 15px">';
                  $res = $res . '<h4 style="margin-left: 10px; padding-top: 10px !important; text-align: center; margin-right: 10px;">';
                  $res = $res . $row["message"];
                  $res = $res . '</h4>';
                  $res = $res . '</div>';
