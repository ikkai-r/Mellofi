...
?>
  ...
  <div>
    ...
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 360px; ">UPDATE SCHEDULE</h1>
    </div>
  </div>
  <br>
  <br>
...
<div>
  <h1 style="color:#A200FF; text-align: center">Update your concert schedule:</h1>
  <h2 style="text-align: center">Please fill in the form below completely.</h2>
</div>
<div class="custom-container mt-5">
      <form action="updating.php" method="post" style="width:100%"   enctype="multipart/form-data">  
          <div class="form-group">
            <label style="color: #8A2BE2"></label>
            <input type="hidden" class="form-control" name="concert_id" required value = "<?php echo $_GET['concert_id'];?>" >
          </div>                    
          <div class="form-group">
            <?php
            ...
            * 
            ...
            <input type="text" class="form-control" name="title" value="'.$row_form["title"].'">
          </div>     
          <div class="form-group">
            <label style="color: #8A2BE2">Price</label>
            <select class="form-control" name="price"  value="'.$row_form["price"].'">
              <option>PREMIUM</option>
              <option>FREE</option>
            </select>            
          </div>
        <div class="form-group">
          <label style="color: #8A2BE2">Date</label>
            <input class="form-control" type="text" name="date" value="'.$row_form["date"].'" onfocus="(this.type=`date`)">
        </div>
        <div class="form-group">
          <label style="color: #8A2BE2">Time</label>
            <input class="form-control" type="text" id="example-time-input" name="time" onfocus="(this.type=`time`)" value="'.$row_form["time"].'">
        </div>
        <div class="form-group mb-5">
          <h5 style="color: #8A2BE2">Upload concert image</h5>
              <div class="mt-5 profile-pic-div">
        <img src="upload/images/'.$row_form["file_src"].'" id="profileDisplay">
             <label for="file_src" id="uploadBtn" style="color: #8A2BE2; width: 400px;  margin-top: -1px; margin-right: -100px !important">Choose Photo</label>
        ...
        <a href="update_sched.php?musician_id='.$_GET["musician_id"].'&concert_id='.$_GET["concert_id"].'" style="color: white"><span class="btn" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Discard</span></a>
        <button type="submit" class="btn" name="update" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Update schedule</button>
';
