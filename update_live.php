...
<html lang="en">
  <head>
    ...
    <title>Update Stream Playback</title>
...
?>
  ...
  <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url(https://news.cgtn.com/news/35456a4d7855444d316b444f33516a4e33416a4e31457a6333566d54/img/ad3713356c2c485b808f9da4145fd80e/ad3713356c2c485b808f9da4145fd80e-2.png);">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 390px; ">UPDATE STREAM</h1>
    </div>
  </div>
  <br>
  <br>
...
<div class="custom-container mt-2">
      ...
      <form action="updatingLive.php" method="post" style="width:100%"   enctype="multipart/form-data">  

              <div class="form-group">
            <label style="color: #8A2BE2"></label>
            <input type="hidden" class="form-control" name="stream_id" id="stream_id" required value = "<?php echo $_GET['stream_id'];?>" >
          </div>           
          <div class="form-group">
            <?php
        ...
        <img src="upload/images/'.$row_form["thumbnail"].'" id="profileDisplay">
             <label for="thumbnail" id="uploadBtn" style="color: #8A2BE2; width: 400px;  margin-top: -1px; margin-right: -100px !important">Choose Photo</label>
              <input type="file"  name="thumbnail" onchange="displayImage(this)" id="thumbnail" style="display: none;">
      </div>
        </div>';

        echo'        

        <a href="contentUpload.php?musician_id='.$_GET["musician_id"].'&stream_id='.$_GET["stream_id"].'" style="color: white"><span class="btn" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Discard</span></a>
        <button type="submit" class="btn" name="update" style="float: right; margin-right: 20px; padding-left: 10px; padding-right: 10px">Update Live</button>
';
