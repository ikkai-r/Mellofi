...
?>
    ...
    <!-- Sidebar -->
    <div class="flex-column flex-shrink-0 p-3 text-white" style=" min-width: 300px; max-width: 300px; height: 1160px; display: block; background-color: #18181b; position: absolute;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <?php 
        echo '<a href="listener-settings.php?listener_id='.$_GET['listener_id'].'"" class="nav-link active creator-studio-icons" aria-current="page">';
        ?>
  <i class="fas fa-cog" style="margin-right: 14px"></i>
    ...
    <li>
       <?php 
       echo'<a href="listener-subscription.php?listener_id='.$_GET['listener_id'].'" class="nav-link creator-studio-icons">';
       ?> 
 ...
 <!-- settings start-->
      <div class="mt-4">
        <div style="margin-left:540px; margin-right: 300px; background-color: #18181b; margin-top: -20px; padding-top: 30px; padding-bottom: 125px; height: 1160px">
           <form class="settings" id="musician-settings" action="update-acc-listener.php" method="post" enctype="multipart/form-data">
            <ul>
              <br>
             ...
             <li>EMAIL 
              ...
              if (isset($_GET["update"])) {
                if ($_GET["update"] == "success") {
                   ...
                   header( "refresh:3;url=listener-settings.php?listener_id=".$_GET["listener_id"]."" );
            ...
            <br><br>
          <button class="btn" id="save-changes" style="float: right; margin-top: -13px; margin-right: -15px" type="submit"> Save Changes </button>
                </form>
         <button class="btn" id="discard" style="float: right; margin-left: 950px;  margin-top:-13px; position: absolute;" onclick='discardBtn()'> Discard </button>
          <span style="position: absolute; margin-top: 95px; margin-left: 120px">DELETE ACCOUNT</span>
          <span style="position: absolute; margin-top: 125px; margin-left: 120px; font-size: 14px">if you wish to delete your account, you may do so by clicking the button to redirect you to the <span style="color: #C551FF">Delete Account</span> page.</span>
          <span class="btn" style="position: absolute; margin-top: 240px; margin-left: 883px;" id="delete-acc-btn">
            Delete Account
          </span>      </div>
  ...
  var username = "<?php if(isset($_GET["username"])) {echo $_GET["username"]; }?>";
  if (username == "taken"){
  ...
  function discardBtn(){
  window.location.href= 'listener-settings.php?listener_id=' + listener_id;
  }
  ...
  function settingsMsg() {
   ...
   $(document).on('click', '#delete-acc-btn', function(){
     var listener_id = "<?php echo $_GET["listener_id"]; ?>";
     window.location.href = "delete-acc-listener.php?listener_id="+listener_id;
   });
