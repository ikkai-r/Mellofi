...
?>
  ...
  <div>
    <div class="custom-container mt-5 header-tab" style="background-image: url('images/bg-following.jpg');">
    </div>
    <div class="custom-container" style="position: absolute; margin-top: -150px;">
       <h1 class="display-2" style=" margin-left: 500px; ">FOLLOWING</h1>
    </div>
  </div>
    ...
    <?php
      ...
      $sql_stream = "
         ...
         FROM 
          ...
          following
         ON 
          `following`.musician_id = `livestreams`.musician_id
          WHERE 
          `following`.username = '".$_SESSION['username']."'
          ORDER By
          stream_id ASC
      ";
             ...
             echo '
              ...
              <div class="jumbotron" style="margin-left: 400px; margin-top: 15px">
                <div class="container">
                  ...
                  <p class="lead">Discover amazing livestreams of artists to follow <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
    ...
    <?php
      ...
      $sql_videos = "
         ...
         FROM 
          ...
          following
         ON 
          `following`.musician_id = `videos`.musician_id
          WHERE 
          `following`.username = '".$_SESSION['username']."'
          ORDER By
          video_id ASC
          ...
          <img src="upload/images/'.$videos[$index]["thumbnail"].'" class="thumbnail">
           ...
           <p class="viewer-cnt">'.$videos[$index]["viewer_cnt"].' views <span style="font-size: 12px;">| Uploaded '.$videos[$index]["stream_time"].' ago<span></p>
            ...
            //if there is no videos 
               echo '
              <div class="jumbotron" style="margin-left: 450px; margin-top: 15px">
                <div class="container">
                   <h1 class="display-4"><i class="fas fa-video" style="font-size:130px"></i></h1>
                  <h3 class="display-4">No videos found</h3>
                  <p class="lead"> Discover amazing videos of artists to follow <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
          }
 ...
 <!-- End Videos Tab -->    
  ...
  <!--Start Tracks Tab-->
      ...
      $sql_music = "
         ...
         INNER JOIN 
          following
         ON 
          `following`.musician_id = `music`.musician_id
          WHERE 
          `following`.username = '".$_SESSION['username']."'
      ";
            ...
            <div class="col-3 mt-5">
              ...
              <div class="jumbotron" style="margin-left: 430px">
                <div class="container">
                  ...
                  <p class="lead">Discover amazing tracks of artists to follow <a href ="homepage.php" style="color: #B303FF">here.</a></p>
                </div>
              </div>';
  ...
  <div class="row custom-container mt-5">
    <?php
      ...
      $count = mysqli_num_rows($result_following);
      if ($count > 0) {
        //if there is following

      for ($index = 0; $index < count($following); $index++) {
            echo'  
       <div class="col-3">
         <div class="following-artist" style="background-image: url(upload/images/'.$following[$index]["profile_pic"].'); filter: blur(2px);">
      </div>
      <div class="following">
          <a href="profile.php?musician_id='.$following[$index]["musician_id"].'" class="following-div">
         <img src="upload/images/'.$following[$index]["profile_pic"].'" class="profile-pic following-pic" >
        <h5 class="following-div">'.$following[$index]["username"].'</h5>
      </a>
      </div>
    </div>';
          }
        ...
        <div class="container">
           <h1 class="display-4"><i class="fas fas fa-user-astronaut" style="font-size: 130px"></i></h1>
          <h3 class="display-4">No users found</h3>
          <p class="lead">Discover artists to follow <a href ="homepage.php" style="color: #B303FF">here.</a></p>
        </div>
      </div>';
